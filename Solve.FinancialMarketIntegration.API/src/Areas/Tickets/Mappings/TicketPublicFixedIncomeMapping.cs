...
{
    public class TicketPublicFixedIncomeMapping : Profile
    {
        public TicketPublicFixedIncomeMapping()
        {
            CreateMap<TicketPublicFixedIncome, TicketPublicFixedIncomeModel>()
                ...
                .ForMember(d => d.PortfolioSelicAccount, o => o.MapFrom(t => t.Ticket.Portfolio.ClearingAccount))
                ...
                .ForMember(d => d.CounterpartSelicAccount, o => o.MapFrom(t => t.Counterpart.ClearingAccount))
