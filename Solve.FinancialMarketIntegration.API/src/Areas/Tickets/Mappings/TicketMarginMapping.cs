...
{
    public class TicketMarginMapping : Profile
    {
        public TicketMarginMapping()
        {
            CreateMap<TicketMargin, TicketMarginModel>()
                ...
                .ForMember(d => d.PortfolioClearingAccount, o => o.MapFrom(t => t.Ticket.Portfolio.ClearingAccount))
                ...
                .ForMember(d => d.CounterpartClearingAccount, o => o.MapFrom(t => t.Counterpart.ClearingAccount))
