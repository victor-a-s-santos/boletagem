...
namespace Solve.FinancialMarketIntegration.API.Areas.Tickets.Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20190729174003_1.0.0.9.zliquidationdata")]
    partial class _1009zliquidationdata
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.Bank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("Bank","Ticket");
                });

            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.EventType", b =>
                {
                    b.Property<short>("Id");
            ...
            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.Ticket", b =>
                {
                    ...
                    b.Property<string>("AccountManagerDocument");
            ...
            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.TicketFundQuotas", b =>
                {
                    ...
                    b.Property<string>("CetipVoiceId")
                        .HasMaxLength(20);
                    ...
                    b.Property<DateTimeOffset?>("LiquidationDate");
            ...
            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.TicketHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.TicketMargin", b =>
                {
                    ...
                    b.Property<decimal?>("IndexPercent");
            ...
            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.TicketSignoff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("TicketSignoff","Ticket");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            TicketTypeId = 1,
                            TimeLimit = new TimeSpan(0, 19, 0, 0, 0),
                            Type = "Cotas - CETIP"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            TicketTypeId = 7,
                            TimeLimit = new TimeSpan(0, 14, 30, 0, 0),
                            Type = "Margem (Depósito\\Vinculação) Título Público"
                        },
                        new
                        {
                            Id = 9,
                            ...
                            TicketTypeId = 7,
                            TimeLimit = new TimeSpan(0, 14, 30, 0, 0),
                            Type = "Margem (Depósito\\Vinculação) Título Privado"
                        },
                        new
                        {
                            Id = 10,
                            ...
                            TicketTypeId = 7,
                            TimeLimit = new TimeSpan(0, 14, 30, 0, 0),
                            Type = "Margem (Depósito\\Vinculação) Renda Variável"
                        },
                        new
                        {
                            Id = 11,
                            ...
                            TicketTypeId = 7,
                            TimeLimit = new TimeSpan(0, 19, 0, 0, 0),
                            Type = "Margem (Retirada\\Desvinculação) Título Público"
                        },
                        new
                        {
                            Id = 12,
                            ...
                            TicketTypeId = 7,
                            TimeLimit = new TimeSpan(0, 19, 0, 0, 0),
                            Type = "Margem (Retirada\\Desvinculação) Título Privado"
                        },
                        new
                        {
                            Id = 13,
                            ...
                            TicketTypeId = 7,
                            TimeLimit = new TimeSpan(0, 20, 0, 0, 0),
                            Type = "Margem (Retirada\\Desvinculação) Renda Variável"
                        },
                        new
                        {
                            Id = 14,
            ...
            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.TicketSignoffLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("TicketSignoffId");
                    ...
                    b.HasIndex("TicketSignoffId");

                    b.ToTable("TicketSignoffLog","Ticket");
                });

            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.TicketSignoffRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("TicketSignoffRequest","Ticket");
                });
                    ...
                    b.OwnsOne("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.Portfolio", "Portfolio", b1 =>
                        {
                            ...
                            b1.Property<string>("Bank")
                                .HasColumnName("PortfolioBank")
                                .HasMaxLength(20)
                                .IsUnicode(false);

                            b1.Property<string>("Branch")
                                .HasColumnName("PortfolioBranch")
                                .HasMaxLength(10)
                                .IsUnicode(false);
            ...
            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.TicketHistory", b =>
                {
                    b.HasOne("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.EventType", "Event")
                        .WithMany()
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.Ticket")
                        .WithMany("History")
            ...
            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.TicketSignoffLog", b =>
                {
                    b.HasOne("Solve.FinancialMarketIntegration.API.Areas.Tickets.Entities.TicketSignoff", "TicketSignoff")
                        .WithMany()
