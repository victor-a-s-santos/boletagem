...
namespace Solve.FinancialMarketIntegration.API.Areas.Security.Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20190627174123_1.0.0.2_Dates")]
            ...
            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Security.Entities.Group", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ChangeDate = new DateTimeOffset(new DateTime(2019, 6, 4, 15, 40, 50, 895, DateTimeKind.Unspecified), new TimeSpan(0, -3, 0, 0, 0)),
                            CreationDate = new DateTimeOffset(new DateTime(2019, 6, 4, 15, 40, 50, 895, DateTimeKind.Unspecified), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("Solve.FinancialMarketIntegration.API.Areas.Security.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordExpirationDate = new DateTimeOffset(new DateTime(2020, 6, 4, 15, 40, 50, 895, DateTimeKind.Unspecified), new TimeSpan(0, -3, 0, 0, 0)),
